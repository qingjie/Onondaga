...
public class DataLoader {
	...
	private void loadData() {
		...
		// create an author
		Author dv = new Author("Qingjie", "Zhao", "zhaoqingjie@gmail.com");
	...
	private void createAuthors() {
		Author jv = new Author("Qingjie0", "Zhao", "zhaoqingjie0@gmail.com");
		authorRepository.save(jv);
		Author av = new Author("Qingjie1", "Zhao", "zhaoqingjie1@gmail.com");
		authorRepository.save(av);
		Author kv = new Author("Qingjie2", "Zhao", "zhaoqingjie2@gmail.com");
	...
	private void createPosts(Author author) {
		...
		Date yesterday = null;
		try {
			yesterday = new SimpleDateFormat("MM/dd/yyyy h:mm:ss a").parse("12/18/2016 12:00:00 PM");
		...
		Post grails = new Post("Swift is awesome!");
		grails.setSlug("swift-is-awesome");
